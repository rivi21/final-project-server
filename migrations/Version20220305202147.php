 ...
 */
final class Version20220305202147 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_E59A1DF44584665A ON shopping_cart_item');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_E59A1DF44584665A ON shopping_cart_item (product_id)');
    }
}
