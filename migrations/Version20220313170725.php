 ...
 */
final class Version20220313170725 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` CHANGE shipping_date shipping_date DATE DEFAULT NULL, CHANGE delivery_date delivery_date DATE DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` CHANGE shipping_date shipping_date DATE NOT NULL, CHANGE delivery_date delivery_date DATE NOT NULL');
