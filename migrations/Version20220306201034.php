 ...
 */
final class Version20220306201034 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD is_preparing TINYINT(1) NOT NULL, ADD is_prepared TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP is_preparing, DROP is_prepared');
