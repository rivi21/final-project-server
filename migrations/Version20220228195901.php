 ...
 */
final class Version20220228195901 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE invoices ADD sales_comission VARCHAR(10) NOT NULL, ADD comission_amount VARCHAR(20) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE invoices DROP sales_comission, DROP comission_amount, CHANGE payment_term payment_term VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
