 ...
 */
final class Version20220301112520 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE shopping_cart_item DROP INDEX IDX_E59A1DF44584665A, ADD UNIQUE INDEX UNIQ_E59A1DF44584665A (product_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE shopping_cart_item DROP INDEX UNIQ_E59A1DF44584665A, ADD INDEX IDX_E59A1DF44584665A (product_id)');
    }
}
