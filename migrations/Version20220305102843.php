 ...
 */
final class Version20220305102843 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_E59A1DF49395C3F3 ON shopping_cart_item');
        $this->addSql('ALTER TABLE shopping_cart_item DROP customer_id, DROP total_amount');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE shopping_cart_item ADD customer_id INT NOT NULL, ADD total_amount INT NOT NULL');
        $this->addSql('ALTER TABLE shopping_cart_item ADD CONSTRAINT FK_E59A1DF49395C3F3 FOREIGN KEY (customer_id) REFERENCES customer (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('CREATE INDEX IDX_E59A1DF49395C3F3 ON shopping_cart_item (customer_id)');
    }
}
