 ...
 */
final class Version20220313174050 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` CHANGE date date VARCHAR(255) NOT NULL, CHANGE shipping_date shipping_date VARCHAR(255) DEFAULT NULL, CHANGE delivery_date delivery_date VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` CHANGE date date VARCHAR(10) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE shipping_date shipping_date VARCHAR(10) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE delivery_date delivery_date VARCHAR(10) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
