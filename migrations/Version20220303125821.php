 ...
 */
final class Version20220303125821 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE invoices ADD is_paid TINYINT(1) NOT NULL, ADD is_paid_date DATE DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE invoices DROP is_paid, DROP is_paid_date, CHANGE payment_term payment_term VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE sales_comission sales_comission VARCHAR(10) NOT NULL COLLATE `utf8mb4_unicode_ci`');
