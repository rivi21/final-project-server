 ...
 */
final class Version20220220155718 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE invoice ADD sales_comission VARCHAR(10) NOT NULL, ADD comission_amount VARCHAR(20) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE delivery CHANGE shipping_conditions shipping_conditions VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE invoice DROP sales_comission, DROP comission_amount, CHANGE payment_terms payment_terms VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
